...
<body>
	...
	<div id="konten">
	    ...
	    <fieldset>
	        <legend>LOGIN PRAKTIKAN
	        		 <br>	
	        		 Sistem Dokumentasi Proyek Laboratorium Teknik Informatika
	   ...
	   <?php echo form_open('verifylogin', $attributes); ?>
	    ...
	    <marquee>STAFF LABORATORIUM TEKNIK INFORMATIKA Gd E.544</marquee>
	    		    <div ><center><a class="btn btn-primary" id="dasar" href="<?php echo base_url();?>index.php/lab_ctr/goToLoginAsisten">LOGIN ASISTEN</a></center></div>
 	</div>
